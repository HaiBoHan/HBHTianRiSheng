...
{
    public partial class FollowServiceDocTypeUIFormWebPart
    {
        ...
        private void BtnCopy_Click_Extend(object sender, EventArgs e)
        {
            ...
            U9.VOB.HBHCommon.HBHCommonUI.HBHUIHelper.UIForm_AfterCopy(this.Model.FollowServiceDocType);
        }
        ...
        private void BtnSubmit_Click_Extend(object sender, EventArgs e)
        {
            ...
            U9.VOB.HBHCommon.HBHCommonUI.HBHUIHelper.UIForm_UpdateStatus(this, this.Model.FollowServiceDocType, U9.VOB.HBHCommon.U9CommonBE.DocStatusData.Approving);
        }
        ...
        private void BtnApprove_Click_Extend(object sender, EventArgs e)
        {
            ...
            U9.VOB.HBHCommon.HBHCommonUI.HBHUIHelper.UIForm_UpdateStatus(this, this.Model.FollowServiceDocType, U9.VOB.HBHCommon.U9CommonBE.DocStatusData.Approved);
        }
        ...
        private void BtnRecovery_Click_Extend(object sender, EventArgs e)
        {
            ...
            U9.VOB.HBHCommon.HBHCommonUI.HBHUIHelper.UIForm_UpdateStatus(this, this.Model.FollowServiceDocType, U9.VOB.HBHCommon.U9CommonBE.DocStatusData.Opened);
        }
        ...
        {
            //查找对话框。
            UFIDA.U9.UI.PDHelper.PDFormMessage.ShowConfirmDialog(this.Page, "d4d63d11-cec4-45e1-b71f-ca9537887624", "580", "408", Title, wpFindID.ClientID, this.BtnFind, null);
            ...
            this.DocHeaderSequence109.AddTypeParams("EntityFullName", "U9.VOB.Cus.HBHTianRiSheng.FollowService");

            this.PrintTemplate88.AddTypeParams("CatalogType", "U9.VOB.Cus.HBHTianRiSheng.FollowService");
        }
        ...
        {
            FollowServiceDocTypeRecord focusedHead = this.Model.FollowServiceDocType.FocusedRecord;
